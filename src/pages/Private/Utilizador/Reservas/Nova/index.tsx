                ...
                <div className="flex flex-col justify-center items-center gap-20">
                    ...
                    {trajeto && date && horarioSelecionado ?
                        ...
                        <div className="flex flex-col justify-center items-center gap-6 shadow-lg rounded-lg w-[50%] p-10">
                            ...
                            <div onClick={() => setIsPopupOpen(true)} className='bg-gradient-to-r w-[50%] font-semibold duration-500 cursor-pointer from-[#F2994A] to-[#FFCA28] py-3 px-4 text-center rounded-lg text-white text-sm'>
                                <p>Reservar</p>
                            </div>
                        </div>
                        :
